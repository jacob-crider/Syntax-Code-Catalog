  ...
  <div class="compiler">
    ...
    <div class="view">
      <div class="loading" v-if="!loading">
        ...
        <router-link class="add-example-button" tag="button" to="/addExample">ADD SNIPPET</router-link>
      </div>
      <div class="gif" v-if="loading">
        <iframe src="https://giphy.com/embed/11FuEnXyGsXFba" width="600" height="450" frameBorder="0"
